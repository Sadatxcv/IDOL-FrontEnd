    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route exact path="/coursePreQuestionnaire-1" element={<CoursePreQuestions />} />
          <Route exact path="/coursePreQuestionnaire-2" element={<CoursePreQuestions2 />} />

          {/* ThemanticAnalysis */}
          <Route exact path="/themanticAnalysis-1" element={<ThemanticAnalysisOne />} />
          <Route exact path="/themanticAnalysis-2" element={<ThemanticAnalysisTwo />} />
