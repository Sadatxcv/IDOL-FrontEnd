  ...
  return (
    <div>
      <Container className="ThemanticAnalysis-Container">
        ...
        <br />
        <center>
          <img src="static/ThemanticAnalysis_image_1.jpg" alt="thematic_img" />
        </center>
        ...
        <div className="ThemanticAnalysis-Video-Container">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/Pkxs5quslFU"
            title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen
        ...
        <br />
        <center>
          <img src="static/ThemanticAnalysis_image_2.jpg" alt="thematic_img" />
        </center>
        ...
        <div className="home-button-ThemanticAnalysis">
          <button class="get-started-ThemanticAnalysis">
            ...
            <a href="/Discussion">
              <span class="button-text-ThemanticAnalysis">Next</span>
            </a>
          </button>
        </div>
      </Container>
